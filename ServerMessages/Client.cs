...
{
    public class Client : SidedMod
    {
        public override Side ModSide => Side.Client;
        ...
        private void OnEnable()
        {
            ...
            _MessageObj.transform.SetParent(Hud.instance.m_rootObject.transform.parent.parent);
        ...
        private void DisplayMessages()
        {
            ...
            if (_MessageText.enabled)
            {
                ...
                {
                    ServerMessagesPlugin.InstanceLogger.LogDebug("hiding announcement");
            ...
            if (!_MessageText.enabled && _Messages.Any())
            {
                ...
                LogDebug("Displaying announcement");
            }
        }
        ...
        public static void RPC_Announcement(long sender, String horizontalAlignment, String verticalAlignment, String senderText, String text)
        {
            ...
            Debug.Log("[Client] Added announcement");
        }
